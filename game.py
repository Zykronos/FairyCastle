...
SCREEN_OFFSET = (window_width//window_width, window_height//window_height) 
    ...
    for y in range(board_height): 
        for x in range(board_width): 
            if x == 0 and y == 0: 
                ...
                y), TILE_DIMENSION, SCREEN_OFFSET, 'A wall') 
                ...
                game_board[y][x] = Tile([sprites['stoneFloor']], (x, y), TILE_DIMENSION, SCREEN_OFFSET, 'The floor') 
...
def update(): 
    ...
    mouse_pos = (p.mouse.get_pos()[0]-SCREEN_OFFSET[0], p.mouse.get_pos()[1]-SCREEN_OFFSET[1]) 
